...
add_shortcode( 'load_upcoming_event', 'load_all_event' );

function load_all_event($atts){

	// Advertisement code pasted inside a variable
$string = '<div id="all_event"></div><script>
jQuery.getScript("/wp-content/themes/twentytwenty/assets/js/event_script.js", function() { get_event();});
</script>';
